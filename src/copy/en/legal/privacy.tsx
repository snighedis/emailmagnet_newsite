...
/**
 * English Privacy Policy, moved verbatim from the page JSX. The English version is the
...
export const privacy = {
  meta: {
    ...
    description:
      "How Dentoku Dev processes personal data under Regulation (EU) 2016/679 (GDPR) and the Italian Privacy Code (D.Lgs. 196/2003 as amended by D.Lgs. 101/2018).",
  },
