...
/**
 * English Terms of Service, moved verbatim from the page JSX. The English version is the
 * one in force; the Italian module is a translation pending legal review.
 */
export const terms = {
  meta: {
  ...
  return (
    <>
      <p className="mt-6 leading-8 text-slate-600">
        Last updated: September 23, 2026. These Terms of Service (&quot;Terms&quot;) form a binding
      ...
      <p className="mt-4 leading-8 text-slate-600">
        ...
        you thereby <strong>waive your right of withdrawal</strong> pursuant to Art. 16(m)
        of Directive 2011/83/EU and Art. 59(1)(o) of D.Lgs. 206/2005.
        {/* Citations corrected on 2026-09-23 (they were swapped): flagged for legal review. */} This waiver is clearly
      ...
      <p className="mt-4 leading-8 text-slate-600">
        <strong>Language.</strong> These Terms are provided in English. An Italian translation is
        available at{" "}
        <Link href="/it/termini" hrefLang="it" lang="it" className="underline underline-offset-2">
          dentokudev.com/it/termini
        </Link>{" "}
        for convenience only and is pending legal review. In the event of conflict between the
        two versions, the English version prevails.
        {/* Pending legal review of the Italian translation. Once a lawyer has signed it off,
            the Italian version may be made to prevail for consumers again. */}
      </p>
