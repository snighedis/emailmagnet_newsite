...
/**
 * English Cookie Policy, moved verbatim from the page JSX. The English version is the
...
export const cookies = {
  meta: {
    ...
    description:
      "Dentoku Dev Cookie Policy: which cookies we use, why, and how to manage or withdraw consent at any time.",
  },
  title: "Cookie Policy",
};
