...
export default function BlogPage() {
  return (
    <>
      ...
      <section className="bg-[#fff7f2] px-4 py-12 md:py-14">
        <div className="mx-auto grid max-w-7xl items-center gap-10 rounded-lg bg-[#fff7f2] px-6 py-8 md:px-10 lg:gap-14 lg:grid-cols-[0.9fr_1.1fr] lg:px-14">
