...
export default function NotFound() {
  return (
    <section className="mx-auto flex min-h-[60vh] max-w-3xl flex-col items-center justify-center px-4 py-20 text-center">
      <p className="text-sm font-semibold uppercase tracking-wide text-[#c43618]">404</p>
      ...
      <Button asChild className="mt-8 rounded-md bg-[#ff5c35] text-white hover:bg-[#df4320]">
